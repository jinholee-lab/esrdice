...
def evaluate_policy_vector(
    ...
    if config.utility_kind == "alpha_fairness":
        vector_transform_utility = Vector_Utility(kind="alpha_fairness", alpha=1 - config.fair_alpha)
        scalarization_utility = Vector_Utility(kind="alpha_fairness", alpha=config.fair_alpha)
